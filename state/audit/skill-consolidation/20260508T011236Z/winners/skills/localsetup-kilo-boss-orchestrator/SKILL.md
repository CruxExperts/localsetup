---
name: localsetup-kilo-boss-orchestrator
...
metadata:
  version: "1.0"
compatibility: Python 3.10+, Kilo CLI 7.x, PyYAML via localsetup deps helper
---
...
Use `localsetup-cron-orchestrator` and keep manifest in `cron/manifest.yaml`.
