...
4. **Copy only after approval**  - Only if the user approves, copy the temp dir (or its contents) into `ls/skills/<name>/`. Do not modify the temp dir after validation.
