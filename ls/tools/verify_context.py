...
def main():
    ...
    print("LocalSetup - Context Verification")
    print("=====================================")
    if skill_md.is_file():
        print(
            "[OK] ls/skills/ls-context/SKILL.md exists (%s bytes)"
            % skill_md.stat().st_size
        )
    else:
        sys.stderr.write(
            "[FAIL] No ls/skills/ls-context/SKILL.md found. Framework not properly installed.\n"
        )
        return 1
