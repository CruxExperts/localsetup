...
class FileBroker:
    ...
    def write_recorded(self, task: str, session: str, name: str, data: bytes, *, expected_before: str | None, journal) -> str:
        ...
        return self._write(task, session, name, data, journal=journal, expected_before=expected_before)

    def _write(self, task, session, name, data, *, journal=None, expected_before=None):
