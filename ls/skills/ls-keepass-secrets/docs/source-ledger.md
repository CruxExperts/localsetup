...
| Local repo `ls/docs/INPUT_HARDENING_STANDARD.md` | External input must be sanitized, validated, and handled with actionable errors. | CLI validates IDs, aliases, env names, YAML roots, and subprocess calls use `shell=False`. | High | None |
