...
def _detect_repo_root(start: Path) -> Path | None:
    ...
    for candidate in (current, *current.parents):
        if candidate.name == "ls" and _has_repo_marker(candidate.parent):
