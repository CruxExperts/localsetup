...
<!-- release-link:start -->
Read the [current release guide](docs/releases/4.25.0.md) for LocalSetup 4.25.0, including compatibility, updating, and verification. Find downloads in the [latest published release](https://github.com/CruxExperts/localsetup/releases/latest).
<!-- release-link:end -->
