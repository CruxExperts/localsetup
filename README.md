...
8. **Versioning** - VERSION at repo root; Conventional Commits drive automatic SemVer bumps, docs sync, and GitHub tag/release publishing (see [_localsetup/docs/VERSIONING.md](_localsetup/docs/VERSIONING.md)).
9. **Skill metadata versioning** - each shipped skill carries `metadata.version`, and generated docs surface those skill versions separately from the framework release version.
