---
name: localsetup-markdown-reference-validator
...
metadata:
  version: "1.0"
compatibility: "Python 3.10+, PyYAML. Config-driven targets and Kilo manifest discovery."
---
...
- **Engine script:** `_localsetup/skills/localsetup-markdown-reference-validator/scripts/markdown_reference_validator.py`
...
Use `localsetup-cron-orchestrator` with `cron/manifest.yaml` for periodic trigger, and XDG autostart desktop entry for login trigger.
...
targets:
  - name: framework-docs-and-skills
    ...
    include_globs:
      - "_localsetup/docs/**/*.md"
      - "_localsetup/skills/**/*.md"
      - "_localsetup/templates/**/*.md"
...
- `_localsetup/skills/localsetup-cron-orchestrator/SKILL.md`
