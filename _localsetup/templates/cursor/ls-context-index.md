...
| ls-omniroute-skill-converter | OmniRoute skill conversion reporting for upstream skill discovery, Localsetup comparison, provenance metadata, and report-first import/update/removal planning | Listing, checking, updating, modifying, importing, or removing OmniRoute-derived Localsetup skills |
