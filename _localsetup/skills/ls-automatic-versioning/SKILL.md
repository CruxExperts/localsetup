...
Version bump and doc sync are performed by the repository owners. Contributors do not need to run any scripts. If you are working in a repo that has the framework release workflow, run the publish workflow from that context as documented there.
