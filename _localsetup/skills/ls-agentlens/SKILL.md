...
This skill consumes AgentLens documentation but does not generate it. Localsetup v3 does not include an `agentlens` CLI, script, or wrapper for regenerating `.agentlens/` output.
