...
```bash
SANDBOX=$(python3 _localsetup/skills/ls-skill-sandbox-tester/scripts/create_sandbox.py --skill-name ls-pr-reviewer)
python3 _localsetup/skills/ls-skill-sandbox-tester/scripts/run_smoke.py --sandbox-dir "$SANDBOX" --command "python3 scripts/pr_review.py --help"
```

**By path:**

```bash
SANDBOX=$(python3 _localsetup/skills/ls-skill-sandbox-tester/scripts/create_sandbox.py --skill-path _localsetup/skills/ls-pr-reviewer)
python3 _localsetup/skills/ls-skill-sandbox-tester/scripts/run_smoke.py --sandbox-dir "$SANDBOX" --command "python3 scripts/pr_review.py --help"
```
