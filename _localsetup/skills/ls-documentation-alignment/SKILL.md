...
3. Map truth sources. For Localsetup, defaults are `VERSION`, `pyproject.toml`, `_localsetup/config/*.yaml`, `_localsetup/skills/*/SKILL.md`, `_localsetup/workflows/*/workflow.yaml`, generated facts, assets, and CI workflows.
