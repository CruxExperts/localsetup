...
This matrix is a snapshot, not a policy. It was verified on 2026-06-23 UTC from
...
|---|---:|---:|---|---|
| `next` | `latest` | `16.2.9` | `canary: 16.3.0-canary.61`, `beta: 16.0.0-beta.0`, `rc: 15.0.0-rc.1` | Node `>=20.9.0`; React peers `^18.2.0 || 19.0.0-rc-de68d2f4-20241204 || ^19.0.0` |
...
| Line | Status on 2026-06-23 | Latest dist entry checked | Notes |
|---|---|---:|---|
| `20.x` | EOL | `v20.20.2` | Iron ended 2026-04-30. Do not choose for new production baselines. |
| `22.x` | Maintenance LTS | `v22.23.0` | Jod ends 2027-04-30. |
| `24.x` | Active LTS | `v24.17.0` | Krypton is the preferred production baseline when supported by the project and host. |
| `25.x` | EOL | `v25.9.0` | Ended 2026-06-01. Avoid for new production baselines. |
| `26.x` | Current | `v26.3.1` | Becomes LTS on the scheduled date if the release plan holds. Avoid as a default production baseline. |
