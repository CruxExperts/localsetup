...
localsetup_provenance:
  schema_version: 1
  source_provenance_hash: 4b473df3b08638decda4320d8a86df9fa6f98bf8cdd7443a80b7c8eba3675732
  emitter: generate-docs
framework_version: 3.8.11
source_commit: f39f608b1fc3da4ff58f5391681667f10fc8bc2c
artifact_sha256: 63a66aa37a0c6e8d31ede545289d0f70fd5bb9185b4b39011f35bed93d2b1e5e
---
...
| `repo-finalizer` | `ls-workflow-repo-finalizer` | Repo Finalizer | Safely inspect repo dirty state and optionally checkpoint allowlisted managed outputs without destructive git operations. | repo finalizer; finalizer harness; finalization checkpoint | `ls-framework-compliance`; `ls-git-workflows` | [HARNESS_AUTOMATION.md](HARNESS_AUTOMATION.md); [WORKFLOW_PACKAGES.md](WORKFLOW_PACKAGES.md); `_localsetup/tools/localsetup_v3.py` |
