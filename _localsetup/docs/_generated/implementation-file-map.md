...
| `keep` | `_localsetup/skills/ls-agentic-prd-batch/SKILL.md` |
| `keep` | `_localsetup/skills/ls-agentic-umbrella-queue/SKILL.md` |
| `keep` | `_localsetup/skills/ls-agentlens/SKILL.md` |
| `keep` | `_localsetup/skills/ls-agentlens/_meta.json` |
...
| `keep` | `_localsetup/skills/ls-ansible-skill/_meta.json` |
...
| `keep` | `_localsetup/skills/ls-arbiter/_meta.json` |
...
| `keep` | `_localsetup/skills/ls-debug-pro/_meta.json` |
| `keep` | `_localsetup/skills/ls-decision-tree-workflow/SKILL.md` |
...
| `keep` | `_localsetup/skills/ls-linux-patcher/_meta.json` |
...
| `keep` | `_localsetup/skills/ls-linux-service-triage/_meta.json` |
...
| `keep` | `_localsetup/skills/ls-mcp-builder/_meta.json` |
...
| `keep` | `_localsetup/skills/ls-pr-reviewer/_meta.json` |
...
| `keep` | `_localsetup/skills/ls-receiving-code-review/_meta.json` |
...
| `keep` | `_localsetup/skills/ls-skill-vetter/_meta.json` |
...
| `keep` | `_localsetup/skills/ls-tdd-guide/_meta.json` |
...
| `keep` | `_localsetup/skills/ls-test-runner/_meta.json` |
| `keep` | `_localsetup/skills/ls-tmux-shared-session-workflow/SKILL.md` |
| `keep` | `_localsetup/skills/ls-unfuck-my-git-state/SKILL.md` |
| `keep` | `_localsetup/skills/ls-unfuck-my-git-state/_meta.json` |
