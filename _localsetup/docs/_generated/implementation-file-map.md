...
| `refactor` | `_localsetup/core/dependency_environments.py` |
...
| `refactor` | `_localsetup/core/provenance_source.py` |
...
| `keep` | `_localsetup/docs/PLUGIN_PACKS.md` |
...
| `generate` | `_localsetup/docs/_generated/plugin-packs.json` |
| `generate` | `_localsetup/docs/_generated/plugin-packs.md` |
...
| `keep` | `_localsetup/skills/ls-codex-heartbeat/scripts/codex_heartbeat_support.py` |
...
| `keep` | `_localsetup/skills/ls-tdd-guide/scripts/metrics_complexity.py` |
| `keep` | `_localsetup/skills/ls-tdd-guide/scripts/output_formatter.py` |
| `keep` | `_localsetup/skills/ls-tdd-guide/scripts/tdd_quality.py` |
