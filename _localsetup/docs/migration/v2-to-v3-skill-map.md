...
| v2 | v3 |
|---|---|
| `localsetup-agentic-prd-batch` | `ls-agentic-prd-batch` |
| `localsetup-agentic-umbrella-queue` | `ls-agentic-umbrella-queue` |
...
| `localsetup-decision-tree-workflow` | `ls-decision-tree-workflow` |
...
| `localsetup-publish-workflow` | `ls-publish-workflow` |
...
| `localsetup-tmux-shared-session-workflow` | `ls-tmux-shared-session-workflow` |
